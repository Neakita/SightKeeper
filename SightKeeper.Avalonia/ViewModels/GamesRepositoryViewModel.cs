...
internal sealed class GamesRepositoryViewModel : IDisposable
{
	...
	public GamesRepositoryViewModel(GamesDataAccess gamesDataAccess, GameIconProvider gameIconProvider)
	{
		...
		_games.Connect()
			.Transform(game => new GameViewModel(game, gameIconProvider))
			.Bind(out var games)
			.Subscribe()
