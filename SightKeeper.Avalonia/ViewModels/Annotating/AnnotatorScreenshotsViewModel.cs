...
internal sealed partial class AnnotatorScreenshotsViewModel : ViewModel
{
    ...
    // private readonly ScreenshotsDataAccess _screenshotsDataAccess = null!;
    private readonly SourceList<Screenshot> _screenshotsSource = new();
    private readonly ReadOnlyObservableCollection<ScreenshotViewModel> _allScreenshots = null!;
    private readonly ReadOnlyObservableCollection<ScreenshotViewModel> _screenshotsWithAssetsAndSelected = null!;
    private readonly ReadOnlyObservableCollection<ScreenshotViewModel> _screenshotsWithoutAssets = null!;
