...
public sealed partial class ExistingProfileEditorViewModel : ValidatableDialogViewModel<EditedProfileData, bool>, ProfileEditorViewModel, EditedProfileData
{
    ...
    public ExistingProfileEditorViewModel(IValidator<EditedProfileData> validator, DataSetsObservableRepository dataSetsObservableRepository) : base(validator)
    {
