...
namespace SightKeeper.Data.Migrations
{
    ...
    [Migration("20230428185618_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SightKeeper.Domain.Model.Detector.DetectorItem", b =>
                {
                    ...
                    b.Property<int?>("DetectorScreenshotId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("DetectorScreenshotId");
            ...
            modelBuilder.Entity("SightKeeper.Domain.Model.Detector.DetectorItem", b =>
                {
                    b.HasOne("SightKeeper.Domain.Model.Detector.DetectorScreenshot", null)
                        .WithMany("Items")
                        .HasForeignKey("DetectorScreenshotId");
