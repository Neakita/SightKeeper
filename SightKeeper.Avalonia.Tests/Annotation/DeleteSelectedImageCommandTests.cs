...
public sealed class DeleteSelectedImageCommandTests
{
	[Fact]
	public void ShouldRaiseCanExecuteChangedWhenSelectedImageAssetsChanged()
	{
		...
		var imageSetSelection = Substitute.For<ImageSetSelection>();
		var command = new DeleteSelectedImageCommand(imageSelection, imageSetSelection);
