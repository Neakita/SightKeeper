...
public sealed class DetectorToolBarTests
{
	[AvaloniaFact]
	...
	private static (DetectorToolBarViewModel viewModel, ListBox listBox) PrepareToolBar()
	{
		DetectorToolBarViewModel viewModel = new();
		DetectorToolBar toolBar = new()
		{
