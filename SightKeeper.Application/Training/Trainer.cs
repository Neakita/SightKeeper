...
public sealed class Trainer
{
	...
	private Task<Weights> SaveWeights(DetectorDataSet dataSet, WeightsMetrics lastWeightsMetrics, ModelSize modelSize, CancellationToken cancellationToken)
	{
		throw new NotImplementedException();
