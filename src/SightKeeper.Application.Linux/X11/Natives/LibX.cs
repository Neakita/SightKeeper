...
internal static unsafe partial class LibX
{
	...
	[LibraryImport(DllName)]
	public static partial uint XDefaultDepth(IntPtr display, int screenNumber);
	...
	[LibraryImport(DllName)]
	public static partial XImage* XGetImage(IntPtr display, IntPtr drawable, int x, int y, uint width, uint height, ulong planeMask, PixmapFormat format);
