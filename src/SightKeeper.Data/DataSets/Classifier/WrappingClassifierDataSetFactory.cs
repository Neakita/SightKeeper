...
internal sealed class WrappingClassifierDataSetFactory(
	Wrapper<DataSet<Tag, ClassifierAsset>> wrapper,
	...
	: Factory<DataSet<Tag, ClassifierAsset>>
{
	public DataSet<Tag, ClassifierAsset> Create()
	{
		...
		StorableArtifactWrapper artifactWrapper = new();
		var inMemorySet = new InMemoryDataSet<Tag, ClassifierAsset>(tagFactory, assetFactory, artifactWrapper);
