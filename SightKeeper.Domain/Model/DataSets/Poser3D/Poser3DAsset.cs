...
public sealed class Poser3DAsset : ItemsAsset<Poser3DItem>
{
	...
	public Poser3DItem CreateItem(Poser3DTag tag, Bounding bounding, IReadOnlyCollection<(Vector2<double>, bool)> keyPoints)
	{
		...
		Poser3DItem item = new(tag, bounding, taggedKeyPoints);
		tag.AddItem(item);
		AddItem(item);
		return item;
	}
